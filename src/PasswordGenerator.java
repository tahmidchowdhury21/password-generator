...
public class PasswordGenerator {
	...
	private final String passwordCharacters = lowerCaseAlphabets + upperCaseAlphabets
											+ numbers + characters;
	...
	/* Requires length parameter for the size of the password
	 * Generates randomPassword using allCharacters by
	 * using secureRandom and stringBuilder libraries
	 */
